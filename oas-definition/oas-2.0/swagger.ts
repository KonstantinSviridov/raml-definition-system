...
export class InfoObject extends extensions.WithSpecificationExtensions{
...
export class ContactObject extends extensions.WithSpecificationExtensions{
    name:string
...
export class LicenseObject extends extensions.WithSpecificationExtensions{
    name:string
...
export class TagObject extends extensions.WithSpecificationExtensions{
    name:string;
...
export class SwaggerObject extends extensions.WithSpecificationExtensions{
    //handled
    // swagger:string
    ...
    //
    definitions:defs.DefinitionObject[]
    $definitions=[MetaModel.embeddedInMaps(),MetaModel.description("An object to hold data types produced and consumed by operations.")]
    //handled
    parameters:defs.ParameterDefinitionObject[]
    $parameters=[MetaModel.embeddedInMaps(),MetaModel.description("An object to hold parameters that can be used across operations. This property does not define global parameters for all operations.")]
    //handled
    responses:defs.ResponseDefinitionObject[];
    $responses=[MetaModel.embeddedInMaps(),MetaModel.description("An object to hold responses that can be used across operations. This property does not define global responses for all operations.")]
    //handled
    securityDefinitions:defs.SecurityDefinitionObject[];
    $securityDefinitions=[MetaModel.embeddedInMaps(),MetaModel.description("Security scheme definitions that can be used across the specification.")]

    security:SecurityRequirementObject[];
    $security=[MetaModel.embeddedInArray(),MetaModel.description("A declaration of which security schemes are applied for the API as a whole. The list of values describes alternative security schemes that can be used (that is, there is a logical OR between the security requirements). Individual operations can override this definition.")]
